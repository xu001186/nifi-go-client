...
/*
InputPortsApiService Gets an input port
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The input port id.
@return PortEntity
*/
func (a *InputPortsApiService) GetInputPort(ctx context.Context, id string) (PortEntity, *http.Response, error) {
	var (
...
/*
InputPortsApiService Deletes an input port
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The input port id.
...
func (a *InputPortsApiService) RemoveInputPort(ctx context.Context, id string, localVarOptionals *InputPortsApiRemoveInputPortOpts) (PortEntity, *http.Response, error) {
	var (
...
/*
InputPortsApiService Updates an input port
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The input port configuration details.
 * @param id The input port id.
@return PortEntity
*/
func (a *InputPortsApiService) UpdateInputPort(ctx context.Context, body PortEntity, id string) (PortEntity, *http.Response, error) {
	var (
...
/*
InputPortsApiService Updates run status of an input-port
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The port run status.
 * @param id The port id.
@return ProcessorEntity
*/
func (a *InputPortsApiService) UpdateRunStatus(ctx context.Context, body PortRunStatusEntity, id string) (ProcessorEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
