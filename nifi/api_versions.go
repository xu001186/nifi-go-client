...
@return string
*/
func (a *VersionsApiService) CreateVersionControlRequest(ctx context.Context, body CreateActiveRequestEntity) (string, *http.Response, error) {
	var (
...
func (a *VersionsApiService) DeleteVersionControlRequest(ctx context.Context, id string, localVarOptionals *VersionsApiDeleteVersionControlRequestOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return string
*/
func (a *VersionsApiService) ExportFlowVersion(ctx context.Context, id string) (string, *http.Response, error) {
	var (
...
@return VersionedFlowUpdateRequestEntity
*/
func (a *VersionsApiService) InitiateRevertFlowVersion(ctx context.Context, body VersionControlInformationEntity, id string) (VersionedFlowUpdateRequestEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VersionedFlowUpdateRequestEntity
*/
func (a *VersionsApiService) InitiateVersionControlUpdate(ctx context.Context, body VersionControlInformationEntity, id string) (VersionedFlowUpdateRequestEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VersionControlInformationEntity
*/
func (a *VersionsApiService) SaveToFlowRegistry(ctx context.Context, body StartVersionControlRequestEntity, id string) (VersionControlInformationEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VersionControlInformationEntity
*/
func (a *VersionsApiService) UpdateFlowVersion(ctx context.Context, body VersionedFlowSnapshotEntity, id string) (VersionControlInformationEntity, *http.Response, error) {
	var (
...
@return VersionControlInformationEntity
*/
func (a *VersionsApiService) UpdateVersionControlRequest(ctx context.Context, body VersionControlComponentMappingEntity, id string) (VersionControlInformationEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
