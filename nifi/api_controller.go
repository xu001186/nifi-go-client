...
*/
func (a *ControllerApiService) GetNodeStatusHistory(ctx context.Context) (ComponentHistoryEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return NodeEntity
*/
func (a *ControllerApiService) UpdateNode(ctx context.Context, body NodeEntity, id string) (NodeEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return RegistryClientEntity
*/
func (a *ControllerApiService) UpdateRegistryClient(ctx context.Context, body RegistryClientEntity, id string) (RegistryClientEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
