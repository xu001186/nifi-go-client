...
*/
func (a *ControllerServicesApiService) DeleteValidationRequest(ctx context.Context, id string, requestId string) (VerifyConfigRequestEntity, *http.Response, error) {
	var (
 ...
 * @param optional nil or *ControllerServicesApiGetPropertyDescriptorOpts - Optional Parameters:
     * @param "Sensitive" (optional.Bool) -  Property Descriptor requested sensitive status
@return PropertyDescriptorEntity
*/

type ControllerServicesApiGetPropertyDescriptorOpts struct {
    Sensitive optional.Bool
}

func (a *ControllerServicesApiService) GetPropertyDescriptor(ctx context.Context, id string, propertyName string, localVarOptionals *ControllerServicesApiGetPropertyDescriptorOpts) (PropertyDescriptorEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ControllerServiceEntity
*/
func (a *ControllerServicesApiService) UpdateRunStatus(ctx context.Context, body ControllerServiceRunStatusEntity, id string) (ControllerServiceEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
