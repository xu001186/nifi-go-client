...
@return RemoteProcessGroupEntity
*/
func (a *RemoteProcessGroupsApiService) UpdateRemoteProcessGroup(ctx context.Context, body RemoteProcessGroupEntity, id string) (RemoteProcessGroupEntity, *http.Response, error) {
	var (
...
*/
func (a *RemoteProcessGroupsApiService) UpdateRemoteProcessGroupInputPort(ctx context.Context, body RemoteProcessGroupPortEntity, id string, portId string) (RemoteProcessGroupPortEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return RemoteProcessGroupPortEntity
*/
func (a *RemoteProcessGroupsApiService) UpdateRemoteProcessGroupInputPortRunStatus(ctx context.Context, body RemotePortRunStatusEntity, id string, portId string) (RemoteProcessGroupPortEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return RemoteProcessGroupPortEntity
*/
func (a *RemoteProcessGroupsApiService) UpdateRemoteProcessGroupOutputPort(ctx context.Context, body RemoteProcessGroupPortEntity, id string, portId string) (RemoteProcessGroupPortEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return RemoteProcessGroupPortEntity
*/
func (a *RemoteProcessGroupsApiService) UpdateRemoteProcessGroupOutputPortRunStatus(ctx context.Context, body RemotePortRunStatusEntity, id string, portId string) (RemoteProcessGroupPortEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return RemoteProcessGroupEntity
*/
func (a *RemoteProcessGroupsApiService) UpdateRemoteProcessGroupRunStatus(ctx context.Context, body RemotePortRunStatusEntity, id string) (RemoteProcessGroupEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return RemoteProcessGroupEntity
*/
func (a *RemoteProcessGroupsApiService) UpdateRemoteProcessGroupRunStatuses(ctx context.Context, body RemotePortRunStatusEntity, id string) (RemoteProcessGroupEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
