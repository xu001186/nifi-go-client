...
*/
func (a *FlowApiService) ActivateControllerServices(ctx context.Context, body ActivateControllerServicesEntity, id string) (ActivateControllerServicesEntity, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FlowApiGetControllerServicesFromControllerOpts - Optional Parameters:
...
func (a *FlowApiService) GetControllerServicesFromController(ctx context.Context, localVarOptionals *FlowApiGetControllerServicesFromControllerOpts) (ControllerServicesEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The process group id.
 * @param optional nil or *FlowApiGetFlowOpts - Optional Parameters:
     * @param "UiOnly" (optional.Bool) - 
...
func (a *FlowApiService) GetFlow(ctx context.Context, id string, localVarOptionals *FlowApiGetFlowOpts) (ProcessGroupFlowEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param optional nil or *FlowApiGetFlowMetricsOpts - Optional Parameters:
     * @param "IncludedRegistries" (optional.Interface of []string) -  Set of included metrics registries
     * @param "SampleName" (optional.String) -  Regular Expression Pattern to be applied against the sample name field
     * @param "SampleLabelValue" (optional.String) -  Regular Expression Pattern to be applied against the sample label value field
     * @param "RootFieldName" (optional.String) -  Name of the first field of JSON object. Applicable for JSON producer only.
...
type FlowApiGetFlowMetricsOpts struct {
    ...
    RootFieldName optional.String
}

func (a *FlowApiService) GetFlowMetrics(ctx context.Context, producer string, localVarOptionals *FlowApiGetFlowMetricsOpts) (StreamingOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.IncludedRegistries.IsSet() {
		localVarQueryParams.Add("includedRegistries", parameterToString(localVarOptionals.IncludedRegistries.Value(), "multi"))
	}
	if localVarOptionals != nil && localVarOptionals.SampleName.IsSet() {
		localVarQueryParams.Add("sampleName", parameterToString(localVarOptionals.SampleName.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.SampleLabelValue.IsSet() {
		localVarQueryParams.Add("sampleLabelValue", parameterToString(localVarOptionals.SampleLabelValue.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.RootFieldName.IsSet() {
		localVarQueryParams.Add("rootFieldName", parameterToString(localVarOptionals.RootFieldName.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
*/
func (a *FlowApiService) GetRuntimeManifest(ctx context.Context) (RuntimeManifestEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/runtime-manifest"
...
*/
func (a *FlowApiService) ScheduleComponents(ctx context.Context, body ScheduleComponentsEntity, id string) (ScheduleComponentsEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
