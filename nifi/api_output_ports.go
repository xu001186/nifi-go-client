...
@return PortEntity
*/
func (a *OutputPortsApiService) UpdateOutputPort(ctx context.Context, body PortEntity, id string) (PortEntity, *http.Response, error) {
	var (
...
*/
func (a *OutputPortsApiService) UpdateRunStatus(ctx context.Context, body PortRunStatusEntity, id string) (ProcessorEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
