...
> ControllerServiceEntity CreateControllerService(ctx, body, id)
...
# **CreateProcessGroup**
> ProcessGroupEntity CreateProcessGroup(ctx, body, id)
...
# **CreateTemplate**
> TemplateEntity CreateTemplate(ctx, body, id)
...
# **InstantiateTemplate**
> FlowEntity InstantiateTemplate(ctx, body, id)
...
> VariableRegistryUpdateRequestEntity SubmitUpdateVariableRegistryRequest(ctx, body, id)
...
> VariableRegistryEntity UpdateVariableRegistry(ctx, body, id)
...
# **UploadProcessGroup**
> ProcessGroupEntity UploadProcessGroup(ctx, id)
...
# **UploadTemplate**
> TemplateEntity UploadTemplate(ctx, template, id)
Uploads a template
