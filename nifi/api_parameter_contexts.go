 ...
 * @param optional nil or *ParameterContextsApiGetParameterContextOpts - Optional Parameters:
     * @param "IncludeInheritedParameters" (optional.Bool) -  Whether or not to include inherited parameters from other parameter contexts, and therefore also overridden values.  If true, the result will be the &#x27;effective&#x27; parameter context.
@return ParameterContextEntity
*/
...
func (a *ParameterContextsApiService) GetParameterContext(ctx context.Context, id string, localVarOptionals *ParameterContextsApiGetParameterContextOpts) (ParameterContextEntity, *http.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals.IncludeInheritedParameters.IsSet() {
		localVarQueryParams.Add("includeInheritedParameters", parameterToString(localVarOptionals.IncludeInheritedParameters.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
@return ParameterContextUpdateRequestEntity
*/
func (a *ParameterContextsApiService) SubmitParameterContextUpdate(ctx context.Context, body ParameterContextEntity, contextId string) (ParameterContextUpdateRequestEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ParameterContextValidationRequestEntity
*/
func (a *ParameterContextsApiService) SubmitValidationRequest(ctx context.Context, body ParameterContextValidationRequestEntity, contextId string) (ParameterContextValidationRequestEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ParameterContextEntity
*/
func (a *ParameterContextsApiService) UpdateParameterContext(ctx context.Context, body ParameterContextEntity, id string) (ParameterContextEntity, *http.Response, error) {
	var (
