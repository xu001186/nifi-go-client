...
*/
func (a *ReportingTasksApiService) AnalyzeConfiguration(ctx context.Context, body ConfigurationAnalysisEntity, id string) (ConfigurationAnalysisEntity, *http.Response, error) {
	var (
...
*/
func (a *ReportingTasksApiService) ClearState(ctx context.Context, id string) (ComponentStateEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ReportingTasksApiService) DeleteValidationRequest(ctx context.Context, id string, requestId string) (VerifyConfigRequestEntity, *http.Response, error) {
	var (
 ...
 * @param optional nil or *ReportingTasksApiGetPropertyDescriptorOpts - Optional Parameters:
     * @param "Sensitive" (optional.Bool) -  Property Descriptor requested sensitive status
@return PropertyDescriptorEntity
*/

type ReportingTasksApiGetPropertyDescriptorOpts struct {
    Sensitive optional.Bool
}

func (a *ReportingTasksApiService) GetPropertyDescriptor(ctx context.Context, id string, propertyName string, localVarOptionals *ReportingTasksApiGetPropertyDescriptorOpts) (PropertyDescriptorEntity, *http.Response, error) {
	var (
...
*/
func (a *ReportingTasksApiService) GetReportingTask(ctx context.Context, id string) (ReportingTaskEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ComponentStateEntity
*/
func (a *ReportingTasksApiService) GetState(ctx context.Context, id string) (ComponentStateEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VerifyConfigRequestEntity
*/
func (a *ReportingTasksApiService) GetVerificationRequest(ctx context.Context, id string, requestId string) (VerifyConfigRequestEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *ReportingTasksApiService) RemoveReportingTask(ctx context.Context, id string, localVarOptionals *ReportingTasksApiRemoveReportingTaskOpts) (ReportingTaskEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VerifyConfigRequestEntity
*/
func (a *ReportingTasksApiService) SubmitConfigVerificationRequest(ctx context.Context, body VerifyConfigRequestEntity, id string) (VerifyConfigRequestEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ReportingTaskEntity
*/
func (a *ReportingTasksApiService) UpdateReportingTask(ctx context.Context, body ReportingTaskEntity, id string) (ReportingTaskEntity, *http.Response, error) {
	var (
...
@return ReportingTaskEntity
*/
func (a *ReportingTasksApiService) UpdateRunStatus(ctx context.Context, body ReportingTaskRunStatusEntity, id string) (ReportingTaskEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
