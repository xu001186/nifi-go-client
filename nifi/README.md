...
*ControllerServicesApi* | [**DeleteValidationRequest**](docs/ControllerServicesApi.md#deletevalidationrequest) | **Delete** /controller-services/{id}/config/verification-requests/{requestId} | Deletes the Verification Request with the given ID
...
*ReportingTasksApi* | [**DeleteValidationRequest**](docs/ReportingTasksApi.md#deletevalidationrequest) | **Delete** /reporting-tasks/{id}/config/verification-requests/{requestId} | Deletes the Verification Request with the given ID
